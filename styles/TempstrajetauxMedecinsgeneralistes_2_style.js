...
var style_TempstrajetauxMedecinsgeneralistes_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("temps_Medecin_generaliste");
    ...
    if (value >= 0.540413 && value <= 3.396322) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.396322 && value <= 6.949505) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.949505 && value <= 18.370575) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.370575 && value <= 34.580389) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.580389 && value <= 63.115607) {
            style = [ new ol.style.Style({
