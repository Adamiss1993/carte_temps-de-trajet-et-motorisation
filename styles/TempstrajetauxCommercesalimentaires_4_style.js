...
var style_TempstrajetauxCommercesalimentaires_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("temps_Commerce_alimentaire");
    ...
    if (value >= 0.309905 && value <= 4.072095) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.072095 && value <= 8.391437) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.391437 && value <= 14.048016) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 14.048016 && value <= 28.607769) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 28.607769 && value <= 59.986371) {
            style = [ new ol.style.Style({
